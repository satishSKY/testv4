...
var Notification = function(){
	this.superMarketSender = new gcm.Sender("AIzaSyD3nf8sOSb1M7LuGs5LLj9K76-eAxQjCsw");/*Supermarket key Android*/
	this.customerSender = new gcm.Sender("AIzaSyDbI6JZKu9JhPkCTYR1JrZDFcF-Rd_oALk");/*Customer KeyAndroid*/
	this.deliverBoySender = new gcm.Sender("GCMAPIKEY");/*Delivery Boy Android*/
	
	this.apnSupermarketConnection = new apn.Connection({cert:__dirname+"/supermarket_Development.pem",key:__dirname+"/apns-prod-key-super.pem",passphrase: "123456"})/*IOS*/
	this.apnCustomerConnection = new apn.Connection({cert:__dirname+"/cusomer_development.pem",key:__dirname+"/apns-prod-key-customer.pem",passphrase: "123456"})/*IOS*/
	this.apnDeliverBoyConnection = new apn.Connection({cert:__dirname+"/deliveryBoy_Development.pem",key:__dirname+"/apns-prod-key-deliver.pem",passphrase: "123456"})/*IOS*/
